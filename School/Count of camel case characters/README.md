<h2><a href="https://www.geeksforgeeks.org/problems/find-the-camel3348/0">Count of camel case characters</a></h2><h3>Difficulty Level : School</h3><hr><div class="problems_problem_content__Xm_eO"><p><span style="font-size:18px">Given a string. Count the number of Camel Case characters in it.</span></p>
